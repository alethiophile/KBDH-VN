label AO_2:
    ...
    "She shot him a glower. \"Stop joking,\" she snapped. \"Seriously! If it's for Yuki's safety, then that's how it has to be — like I said yesterday. But it can't be {i}permanent{/i}, can it? I mean, can't I just fix it so that Yuki doesn't need to rely on me?\""
    ...
    "\"First of all, it's not a race,\" Kyon said, pushing his empty plate towards the center of the table. \"Secondly, she gave you the option to stay in the brigade, so I don't think she actually holds anything {i}against{/i} you, no matter how upset she might be at the moment.\" He glanced to Koizumi, raising an eyebrow questioningly."
    ...
    "\"Ah ... that person.... He is not likable. But I can't tell you much because I don't {i}know{/i} much. To us, he is a criminal, someone attempting to divert the timestream, much like Nagato's superiors at the moment. It would be quite troublesome if they were to join forces, but ... I shouldn't speak further of that.\""
