...
label SF1: 
    ...
    scene bg ClubroomFullDay:
        xpos 0 ypos 0
    $ renpy.layer_at_list([PanScene_SetToRight])
    show Kyon Sigh4 at left_RightScreen
    show Kanae Wince1:
        xalign 1.563 yalign 2.2
    ...
    show Koizumi Crossed Neutral1
    stop music fadeout 3
    "\"'Every world'?\" Haruhi echoed, {nw}"
    scene bg ClubroomLeftDay
    show Haruhi Worry1 at left
    show Koizumi Crossed Neutral1 at right
    show Haruhi Worry1 at center with move
    extend "her eyes suddenly turning sympathetic as she stepped away from the door and sat next to Koizumi, opposite the younger girl. \"Do you mean, you're lost, Kanae-chan?\""
    nvl clear
